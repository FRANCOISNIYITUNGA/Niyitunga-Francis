...
--
-- Host: 127.0.0.1
-- Generation Time: Feb 19, 2024 at 08:46 PM
...
--
CREATE DATABASE IF NOT EXISTS `niyitunga_francois_222004350_smms` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci;
USE `niyitunga_francois_222004350_smms`;
...
('root', 'hod', 'table', 'smms', ''),
('root', 'lecturer', 'table', 'smms', ''),
('root', 'marks', 'table', 'smms', '');
...
('root', '[{\"db\":\"niyitunga_francois_222004350_smms\",\"table\":\"marks\"},{\"db\":\"niyitunga_francois_222004350_smms\",\"table\":\"student\"},{\"db\":\"niyitunga_francois_222004350_smms\",\"table\":\"class\"},{\"db\":\"smms\",\"table\":\"class\"},{\"db\":\"smms\",\"table\":\"marks\"},{\"db\":\"smms\",\"table\":\"hod\"},{\"db\":\"smms\",\"table\":\"lecturer\"},{\"db\":\"smms\",\"table\":\"student\"},{\"db\":\"smms\",\"table\":\"course\"},{\"db\":\"smms\",\"table\":\"HOD\"}]');
...
('smms', 'course', 1, 562, 353),
('smms', 'hod', 1, 574, 186),
('smms', 'mark', 1, 182, 56),
('smms', 'sm', 1, 403, 409),
('smms', 'student', 1, 178, 270),
('smms', 'user', 1, 503, 35);
...
('root', '2024-02-19 19:43:24', '{\"Console\\/Mode\":\"collapse\"}');
...
-- Database: `smms`
--
CREATE DATABASE IF NOT EXISTS `smms` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci;
USE `smms`;
